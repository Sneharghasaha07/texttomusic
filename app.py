...
def generate_lyrics(prompt):
    ...
    response=client.chat.completions.create(
        ...
        messages=[
            {
                "role": "system",
                "content":"You are a music lyrics writer and your task is to write lyrics of music under 30 wprds based on user's prompt.Just return the lyrics and nothing else."  
            },
            {
               "role":"user",
               "content":prompt
